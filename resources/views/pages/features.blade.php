            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 text-center">
                        ...
                        <h2 class="alt-h1 mt-3 mb-2 lh-condensed">
                            Seamless player reviews
                        </h2>
                    </div>
                    <div class="col-md-8 col-md-offset-2 text-center">
                        <p class="f3 mb-6 pb-md-4 mx-auto">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <p class="mb-4">
                            Our tools are free, no costs just easy validation. We only ask you add a logo to your site
                            to spread the word.
                        </p>
                    </div>
                </div>
        ...
        <div class="featurette" id="validation">
            <div class="container text-center">
                ...
                <div class="col-md-6 col-md-offset-3 text-center">
                    <h3 class="alt-h3 my-1">Player to Site</h3>
                    <p>
